...
var _user$project$Main$checkedTaskStyle = {
	ctor: '::',
	_0: _seanhess$elm_style$Style$textDecoration(_seanhess$elm_style$Style$lineThrough),
	_1: {ctor: '[]'}
};
...
var _user$project$Main$checkTask = function (a) {
	var _p0 = a;
	if (_p0.ctor === 'Nothing') {
		return A3(_user$project$Main$Task, '', false, 0);
	} else {
		var _p1 = _p0._0;
		return A3(_user$project$Main$Task, _p1.title, _p1.completed, _p1.id);
	}
};
...
var _user$project$Main$checkScheduler = function (a) {
	...
	if (_p2.ctor === 'Nothing') {
		...
		var _p3 = _p2._0;
		return A6(_user$project$Main$Scheduler, _p3.title, _p3.currentTask, _p3.tasks, _p3.id, _p3.pendingTaskTitle, _p3.stable_id);
	}
};
...
var _user$project$Main$checkBoard = function (a) {
	...
	if (_p4.ctor === 'Nothing') {
		...
		var _p5 = _p4._0;
		return A5(_user$project$Main$Board, _p5.title, _p5.schedulers, _p5.id, _p5.pendingSchedulerTitle, _p5.activeSchedulerIndex);
	}
};
	...
	function (msg, model) {
		...
		switch (_p6.ctor) {
			case 'CheckTask':
				...
				var schedulerIndex = model.clickedSchedulerIndex;
				var activeBoardIndex = model.selectedBoardIndex;
				var oldBoardA = _elm_lang$core$List$head(
					A2(
						_elm_lang$core$List$filter,
						function (board) {
							return _elm_lang$core$Native_Utils.eq(board.id, activeBoardIndex);
						},
				...
				var schedulerA = _elm_lang$core$List$head(
					A2(
						_elm_lang$core$List$filter,
						function (scheduler) {
							return _elm_lang$core$Native_Utils.eq(scheduler.id, schedulerIndex);
						},
						oldBoard.schedulers));
				var schedulerOld = _user$project$Main$checkScheduler(schedulerA);
				var taskOldA = _elm_lang$core$List$head(
					A2(
						_elm_lang$core$List$filter,
						function (task) {
							return _elm_lang$core$Native_Utils.eq(task.id, _p7);
						},
						schedulerOld.tasks));
				var taskOld = _user$project$Main$checkTask(taskOldA);
				var taskNew = _elm_lang$core$Native_Utils.update(
					taskOld,
					{completed: !taskOld.completed});
				var filteredTasks = A2(
					...
					schedulerOld.tasks);
				var schedulerNew = _elm_lang$core$Native_Utils.update(
					schedulerOld,
					{
						tasks: A2(
							...
							{ctor: '::', _0: taskNew, _1: filteredTasks})
					});
				...
				var newBoard = _elm_lang$core$Native_Utils.update(
					oldBoard,
					{
						schedulers: A2(
							...
							{ctor: '::', _0: schedulerNew, _1: filteredSchedulers})
					});
			...
			case 'DragDropMsg':
				var _p8 = A2(_norpan$elm_html5_drag_drop$Html5_DragDrop$update, _p6._0, model.dragDrop);
				var model_ = _p8._0;
				var result = _p8._1;
				return {
					ctor: '_Tuple2',
						...
						model,
						{
							...
							dashboard: function () {
								...
								if (_p9.ctor === 'Nothing') {
									...
									var _p10 = _p9._0._1;
									var oldDashboard = model.dashboard;
									var fromSchedulerIndex = model.clickedSchedulerIndex;
									var activeBoardIndex = model.selectedBoardIndex;
									var oldBoardA = _elm_lang$core$List$head(
										A2(
											_elm_lang$core$List$filter,
											...
											model.dashboard.boards));
									var oldBoard = _user$project$Main$checkBoard(oldBoardA);
									var fromSchedulerOldA = _elm_lang$core$List$head(
										A2(
											_elm_lang$core$List$filter,
											function (scheduler) {
												return _elm_lang$core$Native_Utils.eq(scheduler.id, fromSchedulerIndex);
											},
											oldBoard.schedulers));
									var fromSchedulerOld = _user$project$Main$checkScheduler(fromSchedulerOldA);
									var filteredTasks = A2(
										_elm_lang$core$List$filter,
										function (task) {
											return !_elm_lang$core$Native_Utils.eq(task.id, _p11);
										},
										fromSchedulerOld.tasks);
									var draggedTaskA = _elm_lang$core$List$head(
										A2(
											_elm_lang$core$List$filter,
											function (task) {
												return _elm_lang$core$Native_Utils.eq(task.id, _p11);
											...
											fromSchedulerOld.tasks));
									var draggedTask = _user$project$Main$checkTask(draggedTaskA);
									var fromSchedulerNew = _elm_lang$core$Native_Utils.update(
										fromSchedulerOld,
										{tasks: filteredTasks});
									var toSchedulerOldA = _elm_lang$core$List$head(
										A2(
											_elm_lang$core$List$filter,
											function (scheduler) {
												return _elm_lang$core$Native_Utils.eq(scheduler.id, _p10);
											},
											oldBoard.schedulers));
									var toSchedulerOld = _user$project$Main$checkScheduler(toSchedulerOldA);
									var toSchedulerNew = _elm_lang$core$Native_Utils.update(
										toSchedulerOld,
										{
											tasks: A2(
												_elm_lang$core$List$sortBy,
												...
												{ctor: '::', _0: draggedTask, _1: toSchedulerOld.tasks})
										});
									var filteredSchedulers = A2(
										_elm_lang$core$List$filter,
										function (scheduler) {
											return (!_elm_lang$core$Native_Utils.eq(scheduler.id, fromSchedulerIndex)) && (!_elm_lang$core$Native_Utils.eq(scheduler.id, _p10));
										},
										oldBoard.schedulers);
									var newBoard = _elm_lang$core$Native_Utils.update(
										oldBoard,
										{
											schedulers: A2(
												...
												},
												{
													ctor: '::',
													_0: fromSchedulerNew,
													_1: {ctor: '::', _0: toSchedulerNew, _1: filteredSchedulers}
												})
										});
									var filteredBoards = A2(
										_elm_lang$core$List$filter,
			...
			case 'SetClickedSchedulerIndex':
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{clickedSchedulerIndex: _p6._0}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			...
			case 'SwitchToBoard':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{selectedBoardIndex: _p6._0, forwardToDetails: true}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			...
			case 'AddScheduler':
				...
				var newDashboard = _elm_lang$core$Native_Utils.update(
					oldDashboard,
					{boards: updatedBoards});
				return _elm_lang$core$String$isEmpty(title) ? {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none} : {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{dashboard: newDashboard, currentIndex: model.currentIndex + 1}),
...
var _user$project$Main$Model = F6(
	function (a, b, c, d, e, f) {
		return {dashboard: a, currentIndex: b, forwardToDetails: c, selectedBoardIndex: d, dragDrop: e, clickedSchedulerIndex: f};
	});
var _user$project$Main$initialModel = A6(
	...
	false,
	0,
	_norpan$elm_html5_drag_drop$Html5_DragDrop$init,
	-1);
var _user$project$Main$init = {ctor: '_Tuple2', _0: _user$project$Main$initialModel, _1: _elm_lang$core$Platform_Cmd$none};
var _user$project$Main$CheckTask = function (a) {
	return {ctor: 'CheckTask', _0: a};
};
var _user$project$Main$SetClickedSchedulerIndex = function (a) {
	return {ctor: 'SetClickedSchedulerIndex', _0: a};
};
var _user$project$Main$DragDropMsg = function (a) {
	return {ctor: 'DragDropMsg', _0: a};
};
var _user$project$Main$taskView = function (task) {
	return A2(
		_elm_lang$html$Html$li,
		A2(_norpan$elm_html5_drag_drop$Html5_DragDrop$draggable, _user$project$Main$DragDropMsg, task.id),
		{
			ctor: '::',
			_0: task.completed ? A2(
				_elm_lang$html$Html$span,
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$style(_user$project$Main$checkedTaskStyle),
					_1: {ctor: '[]'}
				},
				{
					ctor: '::',
						...
						_1: {
							...
							_1: {
								...
								_0: _elm_lang$html$Html_Events$onClick(
									_user$project$Main$CheckTask(task.id)),
								_1: {ctor: '[]'}
							}
						}
					},
	...
	return A2(
		_elm_lang$html$Html$li,
		{
			...
			_0: _elm_lang$html$Html_Events$onMouseDown(
				_user$project$Main$SetClickedSchedulerIndex(scheduler.id)),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
				...
				_1: {
					...
					_1: {
						...
						_0: A2(
							...
							A2(_norpan$elm_html5_drag_drop$Html5_DragDrop$droppable, _user$project$Main$DragDropMsg, scheduler.id),
...
var _user$project$Main$boardDetailsView = function (board) {
	return A2(
		...
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('boardDetails'),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
...
var _user$project$Main$detailsView = function (model) {
	...
	if (_p12.ctor === 'Nothing') {
		...
		return _user$project$Main$boardDetailsView(
			A5(_user$project$Main$Board, _p13.title, _p13.schedulers, _p13.id, _p13.pendingSchedulerTitle, _p13.activeSchedulerIndex));
	}
};
...
var _user$project$Main$indexView = function (model) {
	return A2(
		...
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('myclass'),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
